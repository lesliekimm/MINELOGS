...
/*****************************************************
 *                                                   *
 *         class ProcessTimer specification          *
 *                                                   *
 *****************************************************/
...
class ProcessTimer {
 ...
 public:
  ProcessTimer();// Default constructor
  ProcessTimer(clock_t);// Convert constructor
  ~ProcessTimer();// Destructor
  
  // Setters to set ProcessTimer members to values passed in
  void setTimeStart(clock_t);
  void setTimeEnd(clock_t);
  
  // Getters to return ProcessTimer members
