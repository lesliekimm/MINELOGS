...
const int FIELD_SIZE[FIELD_COUNT] = {7, 41, 30, 30, 50, 63, 12,
...
class FIPS_stateReference {
 ...
 public:
  ...
  int getCodeCount() const { return codeCount; }
...
class Mine {
 ...
 public:
  ...
  // In-line boolean implementations
  bool operator>(const Mine &otherMine) { return this->mineID > otherMine.mineID; }
  bool operator>=(const Mine &otherMine) { return this->mineID >= otherMine.mineID; }
  bool operator<(const Mine &otherMine) { return this->mineID < otherMine.mineID; }
  bool operator<=(const Mine &otherMine) { return this->mineID <= otherMine.mineID; }
  bool operator==(const Mine &otherMine) { return this->mineID == otherMine.mineID; }
